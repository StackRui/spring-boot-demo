...
@Service
@RocketMQMessageListener(topic = "order", consumerGroup = "error-order-group", consumeThreadMax = 1, selectorType = SelectorType.SQL92, selectorExpression = "items<=30")
public class ErrorOrderMQListener implements RocketMQListener<MessageExt> {
